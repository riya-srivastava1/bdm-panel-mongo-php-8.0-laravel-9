var app = { id: "#app", isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || window.innerWidth < 992, bootstrap: { tooltip: { attr: 'data-bs-toggle="tooltip"' }, popover: { attr: 'data-bs-toggle="popover"' }, modal: { attr: 'data-bs-toggle="modal"', dismissAttr: 'data-bs-dismiss="modal"', event: { hidden: "hidden.bs.modal" } }, nav: { class: "nav", tabs: { class: "nav-tabs", activeClass: "active", itemClass: "nav-item", itemLinkClass: "nav-link" } } }, ajax: { attr: 'data-toggle="ajax"', clearOption: "", clearElement: ".jvectormap-label, .jvector-label, .AutoFill_border ,#gritter-notice-wrapper, .ui-autocomplete, .colorpicker, .FixedHeader_Header, .FixedHeader_Cloned .lightboxOverlay, .lightbox, .introjs-hints, .nvtooltip, .sp-container, .dz-hidden-input, .lightboxOverlay", emptyElement: '[data-id="app-extra-elm"]', loader: { id: "#app-content-loader", html: '<div id="app-content-loader"><span class="spinner"></span></div>', class: "app-content-loading" }, error: { html: '<div class="px-3 text-center fs-20px"><i class="fa fa-warning fa-lg text-muted me-1"></i> <span class="fw-600 text-inverse">Error 404! Page not found.</span></div>' } }, header: { id: "#header", class: "app-header", hasScrollClass: "has-scroll", brand: { class: "navbar-brand" }, floatingForm: { toggleAttr: 'data-toggle="app-header-floating-form"', dismissAttr: 'data-dismiss="app-header-floating-form"', toggledClass: "app-header-floating-form-toggled" }, inverse: { class: "app-header-inverse" } }, sidebar: { id: "#sidebar", class: "app-sidebar", scrollBar: { localStorage: "appSidebarScrollPosition", dom: "" }, bg: { class: "app-sidebar-bg" }, menu: { class: "menu", disableAnimationAttr: "data-disable-slide-animation", disableAutoCollapseAttr: "data-disable-auto-collapse", animationTime: 250, headerClass: "menu-header", itemClass: "menu-item", itemLinkClass: "menu-link", hasSubClass: "has-sub", activeClass: "active", expandingClass: "expanding", expandClass: "expand", closingClass: "closing", closedClass: "closed", submenu: { class: "menu-submenu" } }, profile: { class: "menu-profile", toggleAttr: 'data-toggle="app-sidebar-profile"', targetAttr: "data-target" }, mobile: { toggleAttr: 'data-toggle="app-sidebar-mobile"', dismissAttr: 'data-dismiss="app-sidebar-mobile"', toggledClass: "app-sidebar-mobile-toggled", closedClass: "app-sidebar-mobile-closed", backdrop: { class: "app-sidebar-mobile-backdrop" } }, minify: { toggleAttr: 'data-toggle="app-sidebar-minify"', toggledClass: "app-sidebar-minified", cookieName: "app-sidebar-minified" }, floatSubmenu: { id: "#app-sidebar-float-submenu", dom: "", timeout: "", class: "app-sidebar-float-submenu", container: { class: "app-sidebar-float-submenu-container" }, arrow: { id: "#app-sidebar-float-submenu-arrow", class: "app-sidebar-float-submenu-arrow" }, line: { id: "#app-sidebar-float-submenu-line", class: "app-sidebar-float-submenu-line" }, overflow: { class: "overflow-scroll mh-100vh" } }, search: { class: "menu-search", toggleAttr: 'data-sidebar-search="true"', hideClass: "d-none", foundClass: "has-text" }, transparent: { class: "app-sidebar-transparent" } }, sidebarEnd: { class: "app-sidebar-end", toggleAttr: 'data-toggle="app-sidebar-end"', toggledClass: "app-sidebar-end-toggled", collapsedClass: "app-sidebar-end-collapsed", mobile: { toggleAttr: 'data-toggle="app-sidebar-end-mobile"', dismissAttr: 'data-dismiss="app-sidebar-end-mobile"', toggledClass: "app-sidebar-end-mobile-toggled", collapsedClass: "app-sidebar-end-mobile-collapsed", closedClass: "app-sidebar-end-mobile-closed" } }, topMenu: { id: "#top-menu", class: "app-top-menu", mobile: { toggleAttr: 'data-toggle="app-top-menu-mobile"' }, menu: { class: "menu", itemClass: "menu-item", linkClass: "menu-link", activeClass: "active", hasSubClass: "has-sub", expandClass: "expand", submenu: { class: "menu-submenu" } }, control: { class: "menu-control", startClass: "menu-control-start", endClass: "menu-control-end", showClass: "show", buttonPrev: { class: "menu-control-start", toggleAttr: 'data-toggle="app-top-menu-prev"' }, buttonNext: { class: "menu-control-end", toggleAttr: 'data-toggle="app-top-menu-next"' } } }, scrollBar: { attr: 'data-scrollbar="true"', skipMobileAttr: "data-skip-mobile", initAttr: "data-init", heightAttr: "data-height", wheelPropagationAttr: "data-wheel-propagation" }, content: { id: "#content", class: "app-content", fullHeight: { class: "app-content-full-height" }, fullWidth: { class: "app-content-full-width" } }, layout: { sidebarLight: { class: "app-with-light-sidebar" }, sidebarEnd: { class: "app-with-end-sidebar" }, sidebarWide: { class: "app-with-wide-sidebar" }, sidebarMinified: { class: "app-sidebar-minified" }, sidebarTwo: { class: "app-with-two-sidebar" }, withoutHeader: { class: "app-without-header" }, withoutSidebar: { class: "app-without-sidebar" }, topMenu: { class: "app-with-top-menu" }, boxedLayout: { class: "boxed-layout" } }, loader: { class: "app-loader", fadingClass: "fading", fadingTime: 200, loadedClass: "loaded" }, panel: { class: "panel", headClass: "panel-heading", titleClass: "panel-title", bodyClass: "panel-body", expandClass: "panel-expand", loadingClass: "panel-loading", loader: { class: "panel-loader", html: '<span class="spinner spinner-sm"></span>' }, toggle: { remove: { attr: 'data-toggle="panel-remove"', tooltipText: "Remove" }, collapse: { attr: 'data-toggle="panel-collapse"', tooltipText: "Collapse / Expand" }, reload: { attr: 'data-toggle="panel-reload"', tooltipText: "Reload" }, expand: { attr: 'data-toggle="panel-expand"', tooltipText: "Expand / Compress" } }, draggable: { disableAttr: 'data-sortable="false"', connectedTarget: ".row > [class*=col]", spinnerHtml: '<i class="fa fa-spinner fa-spin ms-2" data-id="title-spinner"></i>' }, sortable: { class: "ui-sortable", attr: "data-sortable-id", spinnerAttr: 'data-id="title-spinner"', disableAttr: 'data-sortable="false"', parentAttr: 'class*="col-"' }, localStorage: { notSupportMessage: "Your browser is not supported with the local storage", loadedEvent: "localstorage-position-loaded", reset: { attr: 'data-toggle="reset-local-storage"', modal: { id: "#modalResetLocalStorage", title: "Reset Local Storage Confirmation", message: "Would you like to RESET all your saved widgets and clear Local Storage?", alert: "info", confirmResetAttr: 'data-toggle="confirm-reset-local-storage"' } } } }, scrollToTopBtn: { showClass: "show", heightShow: 200, toggleAttr: 'data-toggle="scroll-to-top"', scrollSpeed: 500 }, unlimitedTabs: { class: "tab-overflow", overflowLeft: { class: "overflow-left" }, overflowRight: { class: "overflow-right" }, buttonNext: { class: "next-button", toggleAttr: 'data-click="next-tab"' }, buttonPrev: { class: "prev-button", toggleAttr: 'data-click="prev-tab"' } }, themePanel: { class: "theme-panel", toggleAttr: 'data-toggle="theme-panel-expand"', cookieName: "theme-panel-expand", activeClass: "active", themeListCLass: "theme-list", themeListItemCLass: "theme-list-item", theme: { toggleAttr: 'data-toggle="theme-selector"', cookieName: "app-theme", activeClass: "active", classAttr: "data-theme-class" }, themeHeader: { class: "app-header-inverse", toggleAttr: 'name="app-header-inverse"', cookieName: "app-theme-header" }, themeHeaderFixed: { class: "app-header-fixed", toggleAttr: 'name="app-header-fixed"', cookieName: "app-header-fixed", disabledClass: "app-header-fixed-disabled", errorMessage: "Default Header with Fixed Sidebar option is not supported. Proceed with Default Header with Default Sidebar." }, themeSidebarGrid: { class: "app-sidebar-grid", toggleAttr: 'name="app-sidebar-grid"', cookieName: "app-sidebar-grid" }, themeGradientEnabled: { class: "app-gradient-enabled", toggleAttr: 'name="app-gradient-enabled"', cookieName: "app-gradient-enabled" }, themeSidebarFixed: { class: "app-sidebar-fixed", toggleAttr: 'name="app-sidebar-fixed"', cookieName: "app-sidebar-fixed", disabledClass: "app-sidebar-fixed-disabled", errorMessage: "Default Header with Fixed Sidebar option is not supported. Proceed with Fixed Header with Fixed Sidebar.", mobileErrorMessage: "Mobile view sidebar will always fixed" }, themeDarkMode: { class: "dark-mode", toggleAttr: 'name="app-theme-dark-mode"', cookieName: "app-theme-dark-mode" } }, animation: { attr: "data-animation", valueAttr: "data-value", speed: 1e3, effect: "swing" }, dismissClass: { toggleAttr: "data-dismiss-class", targetAttr: "data-target" }, toggleClass: { toggleAttr: "data-toggle-class", targetAttr: "data-target" }, helper: { display: { none: "d-none" }, margin: { left: { 0: "ms-0" }, right: { 0: "me-0" } } }, font: {}, color: {} },
    ...
    generateScrollbar = function(a) {
        ...
        if (!($(a).attr(app.scrollBar.initAttr) || app.isMobile && $(a).attr(app.scrollBar.skipMobileAttr))) {
            ...
            if ($(a).css("height", e), app.isMobile) $(a).css("overflow-x", "scroll");
                ...
                0 !== $(a).closest("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")").length ? app.sidebar.scrollBar.dom = new PerfectScrollbar(a, { wheelPropagation: s }) : new PerfectScrollbar(a, { wheelPropagation: s })
            }
    ...
    handleSidebarMenu = function() {
        ...
        $(document).on("click", "." + app.sidebar.class + " ." + app.sidebar.menu.class + " > ." + app.sidebar.menu.itemClass + "." + app.sidebar.menu.hasSubClass + " > ." + app.sidebar.menu.itemLinkClass, (function() {
            ...
            0 === $("." + app.sidebar.minify.toggledClass).length && (e || ($(t).closest("." + app.sidebar.menu.itemClass).addClass(app.sidebar.menu.closingClass), $(t).slideUp(a, (function() { $(t).closest("." + app.sidebar.menu.itemClass).addClass(app.sidebar.menu.closedClass).removeClass(app.sidebar.menu.expandClass + " " + app.sidebar.menu.closingClass) }))), $(s).is(":visible") ? $(s).closest("." + app.sidebar.menu.itemClass).addClass(app.sidebar.menu.closingClass).removeClass(app.sidebar.menu.expandClass) : $(s).closest("." + app.sidebar.menu.itemClass).addClass(app.sidebar.menu.expandingClass).removeClass(app.sidebar.menu.closedClass), $(s).slideToggle(a, (function() {
    ...
    handleSidebarToggle = function() {
        "use strict";
        $(document).on("click", "[" + app.sidebar.mobile.toggleAttr + "]", (function(a) { a.preventDefault(), $(app.id).addClass(app.sidebar.mobile.toggledClass).removeClass(app.sidebar.mobile.closedClass) })), $(document).on("click", "[" + app.sidebar.mobile.dismissAttr + "]", (function(a) { a.preventDefault(), $(app.id).removeClass(app.sidebar.mobile.toggledClass).addClass(app.sidebar.mobile.closedClass), setTimeout((function() { $(app.id).removeClass(app.sidebar.mobile.closedClass) }), 250) }))
    },
    handleSidebarEndToggle = function() {
        "use strict";
        $(document).on("click", "[" + app.sidebarEnd.toggleAttr + "]", (function(a) { a.preventDefault(), $(app.id).hasClass(app.sidebarEnd.toggledClass) || $(app.id).hasClass(app.sidebarEnd.collapsedClass) ? $(app.id).hasClass(app.sidebarEnd.toggledClass) ? $(app.id).removeClass(app.sidebarEnd.toggledClass).addClass(app.sidebarEnd.collapsedClass) : $(app.id).removeClass(app.sidebarEnd.collapsedClass).addClass(app.sidebarEnd.toggledClass) : $(app.id).addClass(app.sidebarEnd.collapsedClass) })), $(document).on("click", "[" + app.sidebarEnd.mobile.toggleAttr + "]", (function(a) { a.preventDefault(), $(app.id).addClass(app.sidebarEnd.mobile.toggledClass).removeClass(app.sidebarEnd.mobile.closedClass) })), $(document).on("click", "[" + app.sidebarEnd.mobile.dismissAttr + "]", (function(a) { a.preventDefault(), $(app.id).removeClass(app.sidebarEnd.mobile.toggledClass).addClass(app.sidebarEnd.mobile.closedClass), setTimeout((function() { $(app.id).removeClass(app.sidebarEnd.mobile.closedClass) }), 250) }))
    },
    ...
    handlePanelAction = function() {
        ...
        $(document).on("mouseover", "[" + app.panel.toggle.remove.attr + "]", (function(a) { $(this).attr("data-tooltip-init") || (new bootstrap.Tooltip(this, { title: app.panel.toggle.remove.tooltipText, placement: "bottom" }).show(), $(this).attr("data-tooltip-init", !0)) })), $(document).on("click", "[" + app.panel.toggle.remove.attr + "]", (function(e) { e.preventDefault(), a && a.hide(), $(this).closest("." + app.panel.class).remove() })), $(document).on("mouseover", "[" + app.panel.toggle.collapse.attr + "]", (function(e) { $(this).attr("data-tooltip-init") || ((a = new bootstrap.Tooltip(this, { title: app.panel.toggle.collapse.tooltipText, placement: "bottom" })).show(), $(this).attr("data-tooltip-init", !0)) })), $(document).on("click", "[" + app.panel.toggle.collapse.attr + "]", (function(e) { e.preventDefault(), a && a.hide(), $(this).closest("." + app.panel.class).find("." + app.panel.bodyClass).slideToggle() })), $(document).on("mouseover", "[" + app.panel.toggle.reload.attr + "]", (function(e) { $(this).attr("data-tooltip-init") || ((a = new bootstrap.Tooltip(this, { title: app.panel.toggle.reload.tooltipText, placement: "bottom" })).show(), $(this).attr("data-tooltip-init", !0)) })), $(document).on("click", "[" + app.panel.toggle.reload.attr + "]", (function(e) {
            ...
            if (!$(s).hasClass(app.panel.loadingClass)) {
                ...
                $(s).addClass(app.panel.loadingClass), $(t).prepend(p), setTimeout((function() { $(s).removeClass(app.panel.loadingClass), $(s).find("." + app.panel.loader.class).remove() }), 2e3)
            }
        })), $(document).on("mouseover", "[" + app.panel.toggle.expand.attr + "]", (function(e) { $(this).attr("data-tooltip-init") || ((a = new bootstrap.Tooltip(this, { title: app.panel.toggle.expand.tooltipText, placement: "bottom" })).show(), $(this).attr("data-tooltip-init", !0)) })), $(document).on("click", "[" + app.panel.toggle.expand.attr + "]", (function(e) {
            e.preventDefault(), a && a.hide();
            var s = $(this).closest("." + app.panel.class),
    ...
    handleSavePanelPosition = function(a) {
        ...
        if (0 !== $("." + app.panel.sortable.class).length) {
            ...
            $.when($("." + app.panel.sortable.class).each((function() {
                ...
                s = (s = s.split("?"))[0], localStorage.setItem(s, JSON.stringify(e)), $(a).find("[" + app.panel.sortable.spinnerAttr + "]").delay(500).fadeOut(500, (function() { $(this).remove() }))
            }))
        }
    },
        ...
        try {
            if ("undefined" != typeof Storage && "undefined" != typeof localStorage) {
                ...
                if (e) {
                    ...
                    }))).done((function() { window.dispatchEvent(new CustomEvent(app.panel.localStorage.loadedEvent)) }))
                }
    ...
    handleResetLocalStorage = function() {
        ...
        })), $(document).on(app.bootstrap.modal.event.hidden, '[data-modal-id="' + app.panel.localStorage.reset.modal.id + '"]', (function(a) { $('[data-modal-id="' + app.panel.localStorage.reset.modal.id + '"]').remove() })), $(document).on("click", "[" + app.panel.localStorage.reset.modal.confirmResetAttr + "]", (function(a) {
            a.preventDefault();
    ...
    handleUnlimitedTabsRender = function() {
        function a(a, e) {
            var s = $(a).closest("." + app.unlimitedTabs.class),
                ...
                o = 0,
                i = 0;
            switch ($(s).find("li").each((function() { $(this).hasClass(app.unlimitedTabs.buttonNext.class) || $(this).hasClass(app.unlimitedTabs.buttonPrev.class) || (o += $(this).width()) })), e) {
                case "next":
                    (n = o + p - l) <= l ? (i = n - p, setTimeout((function() { $(s).removeClass(app.unlimitedTabs.overflowRight.class) }), 150)) : i = l - p - 80, 0 !== i && ("rtl" != $("body").css("direction") ? $(s).find("." + app.bootstrap.nav.tabs.class).animate({ marginLeft: "-" + i + "px" }, 150, (function() { $(s).addClass(app.unlimitedTabs.overflowLeft.class) })) : $(s).find("." + app.bootstrap.nav.tabs.class).animate({ marginRight: "-" + i + "px" }, 150, (function() { $(s).addClass(app.unlimitedTabs.overflowLeft.class) })));
                    break;
                case "prev":
                    var n;
                    (n = -p) <= l ? ($(s).removeClass(app.unlimitedTabs.overflowLeft.class), i = 0) : i = n - l + 80, "rtl" != $("body").css("direction") ? $(s).find("." + app.bootstrap.nav.tabs.class).animate({ marginLeft: "-" + i + "px" }, 150, (function() { $(s).addClass(app.unlimitedTabs.overflowRight.class) })) : $(s).find("." + app.bootstrap.nav.tabs.class).animate({ marginRight: "-" + i + "px" }, 150, (function() { $(s).addClass(app.unlimitedTabs.overflowRight.class) }))
            }
        }
            ...
            $("." + app.unlimitedTabs.class).each((function() {
                ! function(a, e) {
                    ...
                    var t = "rtl" == $("body").css("direction") ? "margin-right" : "margin-left",
                        ...
                        o = e > -1 ? e : 150,
                        i = 0;
                    if ($(a).find(s).prevAll().each((function() { l += $(this).width() })), $(a).find("." + app.bootstrap.nav.tabs.itemClass).each((function() { i += $(this).width() })), l >= p) {
                        var n = l - p;
                        i != l && (n += 40), "rtl" == $("body").css("direction") ? $(a).find("." + app.bootstrap.nav.tabs.class).animate({ marginRight: "-" + n + "px" }, o) : $(a).find("." + app.bootstrap.nav.tabs.class).animate({ marginLeft: "-" + n + "px" }, o)
                    }
        ...
        $("[" + app.unlimitedTabs.buttonNext.toggleAttr + "]").click((function(e) { e.preventDefault(), a(this, "next") })), $("[" + app.unlimitedTabs.buttonPrev.toggleAttr + "]").click((function(e) { e.preventDefault(), a(this, "prev") })), $(window).resize((function() { $("." + app.unlimitedTabs.class + " ." + app.bootstrap.nav.tabs.class).removeAttr("style"), e() })), e()
    },
    handleUnlimitedTopMenuRender = function() {
        ...
        function e() {
            var a = $("." + app.topMenu.class + " ." + app.topMenu.menu.class),
                ...
                i = 0;
            if ($(s).prevAll().each((function() { o += $(this).width() })), $(e).each((function() { $(this).hasClass(app.topMenu.control.class) || (i += $(this).width()) })), o >= l) { var n = o - l + 128; "rtl" != $("body").css("direction") ? $(a).animate({ marginLeft: "-" + n + "px" }, 0) : $(a).animate({ marginRight: "-" + n + "px" }, 0) }
        ...
        $("[" + app.topMenu.control.buttonNext.toggleAttr + "]").click((function(e) { e.preventDefault(), a(this, "next") })), $("[" + app.topMenu.control.buttonPrev.toggleAttr + "]").click((function(e) { e.preventDefault(), a(this, "prev") })), $(window).resize((function() { $(window).width() > 767 ? ($("." + app.topMenu.class + " ." + app.topMenu.menu.class).removeAttr("style"), e()) : $("." + app.topMenu.class + " ." + app.topMenu.menu.class).removeAttr("style") })), e()
    },
    handleTopMenuSubMenu = function() {
        ...
        $(document).on("click", "." + app.topMenu.class + " ." + app.topMenu.menu.submenu.class + " ." + app.topMenu.menu.hasSubClass + " > ." + app.topMenu.menu.linkClass, (function() {
            ...
            $(e).not(a).slideUp(250, (function() { $(this).closest("." + app.topMenu.menu.itemClass).removeClass(app.topMenu.menu.expandClass) })), $(a).slideToggle(250, (function() {
    ...
    handleMobileTopMenuSubMenu = function() {
        ...
        $(document).on("click", "." + app.topMenu.class + " ." + app.topMenu.menu.class + " > ." + app.topMenu.menu.itemClass + "." + app.topMenu.menu.hasSubClass + " > ." + app.topMenu.menu.linkClass, (function() {
            if ($(window).width() <= 767) {
                ...
                $(e).not(a).slideUp(250, (function() { $(this).closest("." + app.topMenu.menu.itemClass).removeClass("expand") })), $(a).slideToggle(250, (function() {
                    var a = $(this).closest("." + app.topMenu.menu.itemClass);
                    $(a).hasClass(app.topMenu.menu.expandClass) ? $(a).removeClass(app.topMenu.menu.expandClass) : $(a).addClass(app.topMenu.menu.expandClass)
                }))
            }
    ...
    handleTopMenuMobileToggle = function() {
        "use strict";
        $(document).on("click", "[" + app.topMenu.mobile.toggleAttr + "]", (function() { $("." + app.topMenu.class).slideToggle(250) }))
    },
    handlePageScrollClass = function() {
        var a = function() { $(window).scrollTop() > 0 ? $(app.id).addClass(app.header.hasScrollClass) : $(app.id).removeClass(app.header.hasScrollClass) };
        $(window).on("scroll", (function() { a() })), a()
    },
    handleToggleNavProfile = function() {
        ...
        $(document).on("click", "[" + app.sidebar.profile.toggleAttr + "]", (function(e) {
            ...
            $(t).is(":visible") ? ($(s).removeClass(app.sidebar.menu.activeClass), $(t).removeClass(app.sidebar.menu.closingClass)) : ($(s).addClass(app.sidebar.menu.activeClass), $(t).addClass(app.sidebar.menu.expandingClass)), $(t).slideToggle(a, (function() { $(t).is(":visible") ? ($(t).addClass(app.sidebar.menu.expandClass), $(t).removeClass(app.sidebar.menu.closedClass)) : ($(t).addClass(app.sidebar.menu.closedClass), $(t).removeClass(app.sidebar.menu.expandClass)), $(t).removeClass(app.sidebar.menu.expandingClass + " " + app.sidebar.menu.closingClass) }))
        }))
    },
    handleSidebarScrollMemory = function() {
        if (!app.isMobile) try {
            if ("undefined" != typeof Storage && "undefined" != typeof localStorage) {
                $("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ") [" + app.scrollBar.attr + "]").on("scroll", (function() { localStorage.setItem(app.sidebar.scrollBar.localStorage, $(this).scrollTop()) }));
                var a = localStorage.getItem(app.sidebar.scrollBar.localStorage);
                a && $("." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ") [" + app.scrollBar.attr + "]").animate({ scrollTop: a + "px" }, 0)
            }
        } catch (a) { console.log(a) }
    },
    handleMouseoverFloatSubMenu = function(a) { clearTimeout(app.sidebar.floatSubmenu.timeout) },
    handleMouseoutFloatSubMenu = function(a) { app.sidebar.floatSubmenu.timeout = setTimeout((function() { $(app.sidebar.floatSubmenu.id).remove() }), 150) },
            ...
            $(e).is(":visible") ? ($(s).addClass("closing"), t = !0) : ($(s).addClass("expanding"), p = !0), $(e).slideToggle({
                ...
                progress: function() {
                    var a = $(app.sidebar.floatSubmenu.id),
                        ...
                        n = $(window).height();
                    if (t && i > l && (i = i > l ? l : i, $(app.sidebar.floatSubmenu.id).css({ top: i + "px", bottom: "auto" }), $(app.sidebar.floatSubmenu.arrow.id).css({ top: "20px", bottom: "auto" }), $(app.sidebar.floatSubmenu.line.id).css({ top: "20px", bottom: "auto" })), p && n - i < e) {
                        var r = n - o - 22;
                        $(app.sidebar.floatSubmenu.id).css({ top: "auto", bottom: 0 }), $(app.sidebar.floatSubmenu.arrow.id).css({ top: "auto", bottom: r + "px" }), $(app.sidebar.floatSubmenu.line.id).css({ top: "20px", bottom: r + "px" })
                    }
                },
                complete: function() { $(e).is(":visible") ? ($(s).addClass("expand"), $(s).removeClass("closed")) : ($(s).addClass("closed"), $(s).removeClass("expand")), $(s).removeClass("closing expanding") }
            })
        })), $(document).on({
            mouseenter: function() {
                if ($(app.id).hasClass(app.sidebar.minify.toggledClass)) {
                    ...
                    if (e) {
                        ...
                        if (r - o > (l = $(app.sidebar.floatSubmenu.id).height())) $(app.sidebar.floatSubmenu.id).css({ top: o, left: i, bottom: "auto", right: n }), $(app.sidebar.floatSubmenu.arrow.id).css({ top: "20px", bottom: "auto" }), $(app.sidebar.floatSubmenu.line.id).css({ top: "20px", bottom: "auto" });
                        else {
                            $(app.sidebar.floatSubmenu.id).css({ bottom: 0, top: "auto", left: i, right: n });
                            var c = r - o - 21;
                            $(app.sidebar.floatSubmenu.arrow.id).css({ top: "auto", bottom: c + "px" }), $(app.sidebar.floatSubmenu.line.id).css({ top: "20px", bottom: c + "px" })
                        }
                    } else $(app.sidebar.floatSubmenu.line.id).remove(), app.sidebar.floatSubmenu.dom = ""
                }
            },
            mouseleave: function() { $(app.id).hasClass(app.sidebar.minify.toggledClass) && (app.sidebar.floatSubmenu.timeout = setTimeout((function() { $(app.sidebar.floatSubmenu.line.id).remove(), app.sidebar.floatSubmenu.dom = "" }), 250)) }
    ...
    handleAjaxMode = function(a) {
        ...
        function t(a) { a ? ($(app.ajax.loader.id).remove(), $("body").removeClass(app.ajax.loader.class)) : 0 === $(app.ajax.loader.id).length && ($("body").addClass(app.ajax.loader.class), $(content.id).append()) }

        function p(s, p, l) {
            Pace.restart(), t(!1),
                function() {
                    if ($(app.ajax.clearElement).remove(), $(app.sidebar.floatSubmenu.id).remove(), $.fn.DataTable) try { $(".dataTable").DataTable().destroy() } catch (a) {}
            ...
            switch (a) {
                ...
                case "number":
                    ...
                    $({ animateNumber: 0 }).animate({ animateNumber: e }, {
                        ...
                        done: function() { $(s).text(convertNumberWithCommas(e)) }
                    });
                    break;
                case "class":
                    $(this).addClass(e)
    ...
    stringToColor = function(a) { for (var e = 0, s = 0; s < a.length; s++) e = a.charCodeAt(s) + ((e << 5) - e); var t = "#"; for (s = 0; s < 3; s++) { t += ("00" + (e >> 8 * s & 255).toString(16)).substr(-2) } return t },
    hexToRgba = function(a, e = 1, s = !1) { var t; if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(a)) return 3 == (t = a.substring(1).split("")).length && (t = [t[0], t[0], t[1], t[1], t[2], t[2]]), "rgba(" + [(t = "0x" + t.join("")) >> 16 & 255, t >> 8 & 255, 255 & t].join(",") + "," + e + ")"; if (!s) return a = stringToColor(a), hexToRgba(a, e, !0); throw new Error("Bad Hex") },
    getCssVariable = function(a) { return window.getComputedStyle(document.body).getPropertyValue(a).trim() },
    App = function() {
        "use strict";
        var a;
        return {
            init: function(e) { e && (a = e), this.initLocalStorage(), this.initTopMenu(), this.initComponent(), this.initPageLoad(), this.initSidebar(), this.initThemePanel(), this.initVariable(), $(window).trigger("load"), a && a.ajaxMode && this.initAjax() },
            settings: function(e) { e && (a = e) },
            initSidebar: function() { handleSidebarMenu(), handleSidebarToggle(), handleSidebarEndToggle(), handleSidebarMinify(), handleSidebarMinifyFloatMenu(), handleToggleNavProfile(), handleToggleNavbarSearch(), handleSidebarSearch(), (!a || a && !a.disableSidebarScrollMemory) && handleSidebarScrollMemory() },
            ...
            initPageLoad: function() { handlePageLoader() },
